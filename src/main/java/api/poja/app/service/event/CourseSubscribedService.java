    ...
    <tr>
      <td style="padding: 40px 40px 32px 40px;">
        ...
        <p style="font-size: 15px; line-height: 1.6; color: #334155; margin: 0 0 32px 0;">
          ...
          <strong style="color: #001c4c; font-size: 16px; display: inline-block; margin-top: 6px;">%s</strong>
        </p>

        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tr>
            <td align="center">
              <a href="%s" style="background-color: #dda625; color: #001c4c; text-decoration: none; padding: 14px 32px; border-radius: 6px; font-size: 14px; font-weight: 700; display: inline-block; transition: all 0.2s ease; letter-spacing: 0.03em; box-shadow: 0 2px 6px rgba(221, 166, 37, 0.2);">
...
"""
            .formatted(escapeHtml(event.getCourseTitle()), presignedUrl);
